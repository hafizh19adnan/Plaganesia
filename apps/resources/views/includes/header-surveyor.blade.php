  ...
  <nav class=" white darken-2" role="navigation">
    <div class="nav-wrapper container">
      ...
      <ul class="right hide-on-med-and-down">
        <li><a href="list-survey" class="grey-text">Daftar Survey</a></li>
        <li><a href="login" class="grey-text">Logout</a></li>
      </ul>

      <ul id="nav-mobile" class="side-nav">
        <li><a href="berita" class="grey-text">Daftar Survey</a></li>
        <li><a href="login" class="grey-text">Logout</a></li>
      </ul>
